...
impl Reg {
    pub fn asm(&self, assembly_type: Option<AssemblyType>) -> String {
        match self {
            ...
            Reg::XMM8 => "%xmm8".to_string(),
            Reg::XMM9 => "%xmm9".to_string(),
            Reg::XMM10 => "%xmm10".to_string(),
            Reg::XMM11 => "%xmm11".to_string(),
            Reg::XMM12 => "%xmm12".to_string(),
            Reg::XMM13 => "%xmm13".to_string(),
            Reg::XMM14 => "%xmm14".to_string(),
            Reg::XMM15 => "%xmm15".to_string(),
            // Integer registers with size variants
