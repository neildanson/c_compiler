...
impl Tokenizer {
    pub fn new() -> Self {
        let token_mappers = vec![
            ...
            TokenMapper::new(r"^([0-9]+)[^\w.]", Box::new(Token::Constant)),
            TokenMapper::new(r"^([0-9]+[lL])[^\w.]", Box::new(Token::LongConstant)),
            TokenMapper::new(r"^([0-9]+[uU])[^\w.]", Box::new(Token::UnsignedIntConstant)),
            TokenMapper::new(
                r"^([0-9]+([lL][uU]|[uU][lL]))[^\w.]",
